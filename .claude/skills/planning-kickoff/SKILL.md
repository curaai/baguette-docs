...
description: >
  ...
  "컨텐츠 기획 시작". 전체 게임 컨셉 제로베이스는 brainstorm 스킬을 쓴다.
---

# 기획 킥오프 (컨텐츠 단위)

**zenith-orchestrator** 가 기존 Baguette 안 **컨텐츠/시스템 한 덩어리**를 새로 기획할 때 **기본 진입**.  
`brainstorm` = 게임 컨셉 제로베이스. **이 스킬 = 이미 있는 게임 안의 주제 시작.**
...
1. Zenith가 **간단한 아이디어 2~3개** (컨텐츠 단위만). **brainstorm 풀 파이프라인 돌리지 말 것.**
...
|--|------------------|------------|
| 언제 | 기존 게임 안 **컨텐츠 단위** 시작 | **게임 컨셉** 제로베이스 |
| 산출 초반 | 요소·아이디어·레퍼런스 브리핑 | 컨셉 문서·필러 파이프라인 |
| Phase 1–2 | planning 본문 Write **금지** | 스킬 자체 Phase 따름 |
